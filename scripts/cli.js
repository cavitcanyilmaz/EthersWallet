...
const contractABI = require("../artifacts/contracts/Etherswallet.sol/Etherswallet.json").abi;

program
    .name("etherswallet-cli")
    .description("CLI tool for Etherswallet smart contract")
    .version("1.0.0");
