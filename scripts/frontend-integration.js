 ...
 * This file demonstrates how to integrate Etherswallet with a web frontend
 */

// For React/Vue/Angular applications
export class EtherswalletClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EtherswalletClient(provider, contractAddress);
